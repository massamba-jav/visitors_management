...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = $utilisateurModel->updateUtilisateur(
        $id,
        $_POST['username'],
        $_POST['password'],
        $_POST['nom'],
...
<div class="container py-4">
    ...
    <div class="form-card">
        ...
        <form method="post" action="">
            ...
            <div class="mb-3">
                <label for="password" class="form-label"><i class="fa-solid fa-lock"></i> Mot de passe (laisser vide pour ne pas changer)</label>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="role" name="role" required>
                    <option value="user" <?= $utilisateur['role'] === 'user' ? 'selected' : '' ?>>Utilisateur standard</option>
