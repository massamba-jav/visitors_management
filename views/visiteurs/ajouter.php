...
// Récupération des listes pour les sélecteurs
$employes = $employeModel->getEmployes();

// Traitement du formulaire d'ajout
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $visiteurController = new VisiteursController($db);
    $result = $visiteurController->ajouter();
    
    if ($result['success']) {
        $_SESSION['message'] = 'Visiteur ajouté avec succès !';
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="type_piece" name="type_piece" required>
                    <option value="" selected disabled>Sélectionner le type de votre pièce</option>
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="employe" name="ide" required>
                    <option value="" selected disabled>Sélectionner l'employé à visiter</option>
                    <?php foreach ($employes as $employe): ?>
                        <option value="<?= $employe['ide'] ?>" >
            ...
            <div class="d-flex justify-content-end gap-2">
                <button type="submit" class="btn btn-orange"><i class="fa-solid fa-plus me-1"></i>Ajouter</button>
