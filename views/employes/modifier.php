...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($prenom) || empty($telephone)) {
        ...
        if ($employeModel->updateEmploye($id, $nom, $prenom, $email, $telephone, $idd)) {
            $success = true;
    ...
    <div class="form-card">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="<?= htmlspecialchars($employe['email']) ?>">
            </div>
            <div class="mb-3">
                <label for="telephone" class="form-label"><i class="fa-solid fa-phone"></i> Téléphone</label>
                <input type="text" class="form-control" id="telephone" name="telephone" value="<?= htmlspecialchars($employe['telephone']) ?>" required>
            </div>
            <div class="mb-3">
                ...
                <select class="form-control" id="idd" name="idd" required>
                    ...
                    <?php foreach ($departements as $departement): ?>
                        <option value="<?= $departement['idd']; ?>" <?= ($employe['idd'] == $departement['idd']) ? 'selected' : ''; ?>>
