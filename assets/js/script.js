...
const nameEl = document.querySelector('.form-container .form-row input[name="username"]'); // modifié
...
const passwordTl = createEmailTl(); // Réutilise la même animation
...
submitBtn.addEventListener('click', () => {
    if (passwordValid && checkboxEl.checked && nameValid && sprayRepeatCounter > 1) {
        gsap.to("svg > *", {
            duration: .1,
            opacity: 0,
            stagger: {
